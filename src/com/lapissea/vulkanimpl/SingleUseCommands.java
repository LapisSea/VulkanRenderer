...
public class SingleUseCommands implements AutoCloseable{
	...
	public SingleUseCommands(MemoryStack stack, VkCommandPool pool, VkGpu gpu){
		this.stack=stack;
		this.gpu=gpu;
		...
		//VkGpu gpu, VkCommandPool pool, VkCommandBufferAllocateInfo allocInfo, PointerBuffer dest
		commandBuffer=Vk.allocateCommandBuffers(gpu, pool, allocInfo, stack.mallocPointer(1))[0];
