...
//		if(DEV_ON) VkFormatAnalysis.generateCode();
		...
		INFO.put(1, new VkFormatInfo(1, "VK_FORMAT_R4G4_UNORM_PACK8", Arrays.asList(new Component(ComponentType.RED, 4, StorageType.NORM, false, 0), new Component(ComponentType.GREEN, 4, StorageType.NORM, false, 0)), Collections.singletonList(8), null, false, null));
		INFO.put(125, new VkFormatInfo(125, "VK_FORMAT_X8_D24_UNORM_PACK32", Arrays.asList(new Component(ComponentType.UNUSED, 8, StorageType.NORM, false, 0), new Component(ComponentType.DEPTH, 24, StorageType.NORM, false, 0)), Collections.singletonList(32), null, false, null));
		...
		INFO.put(5, new VkFormatInfo(5, "VK_FORMAT_B5G6R5_UNORM_PACK16", Arrays.asList(new Component(ComponentType.BLUE, 5, StorageType.NORM, false, 0), new Component(ComponentType.GREEN, 6, StorageType.NORM, false, 0), new Component(ComponentType.RED, 5, StorageType.NORM, false, 0)), Collections.singletonList(16), null, false, null));
		INFO.put(4, new VkFormatInfo(4, "VK_FORMAT_R5G6B5_UNORM_PACK16", Arrays.asList(new Component(ComponentType.RED, 5, StorageType.NORM, false, 0), new Component(ComponentType.GREEN, 6, StorageType.NORM, false, 0), new Component(ComponentType.BLUE, 5, StorageType.NORM, false, 0)), Collections.singletonList(16), null, false, null));
		...
		INFO.put(122, new VkFormatInfo(122, "VK_FORMAT_B10G11R11_UFLOAT_PACK32", Arrays.asList(new Component(ComponentType.BLUE, 10, StorageType.FLOAT, false, 0), new Component(ComponentType.GREEN, 11, StorageType.FLOAT, false, 0), new Component(ComponentType.RED, 11, StorageType.FLOAT, false, 0)), Collections.singletonList(32), null, false, null));
		...
		INFO.put(56, new VkFormatInfo(56, "VK_FORMAT_A8B8G8R8_SINT_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 8, StorageType.INT, true, 0), new Component(ComponentType.BLUE, 8, StorageType.INT, true, 0), new Component(ComponentType.GREEN, 8, StorageType.INT, true, 0), new Component(ComponentType.RED, 8, StorageType.INT, true, 0)), Collections.singletonList(32), null, false, null));
		...
		INFO.put(69, new VkFormatInfo(69, "VK_FORMAT_A2B10G10R10_SINT_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 2, StorageType.INT, true, 0), new Component(ComponentType.BLUE, 10, StorageType.INT, true, 0), new Component(ComponentType.GREEN, 10, StorageType.INT, true, 0), new Component(ComponentType.RED, 10, StorageType.INT, true, 0)), Collections.singletonList(32), null, false, null));
		INFO.put(63, new VkFormatInfo(63, "VK_FORMAT_A2R10G10B10_SINT_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 2, StorageType.INT, true, 0), new Component(ComponentType.RED, 10, StorageType.INT, true, 0), new Component(ComponentType.GREEN, 10, StorageType.INT, true, 0), new Component(ComponentType.BLUE, 10, StorageType.INT, true, 0)), Collections.singletonList(32), null, false, null));
		...
		INFO.put(7, new VkFormatInfo(7, "VK_FORMAT_B5G5R5A1_UNORM_PACK16", Arrays.asList(new Component(ComponentType.BLUE, 5, StorageType.NORM, false, 0), new Component(ComponentType.GREEN, 5, StorageType.NORM, false, 0), new Component(ComponentType.RED, 5, StorageType.NORM, false, 0), new Component(ComponentType.ALPHA, 1, StorageType.NORM, false, 0)), Collections.singletonList(16), null, false, null));
		...
		INFO.put(2, new VkFormatInfo(2, "VK_FORMAT_R4G4B4A4_UNORM_PACK16", Arrays.asList(new Component(ComponentType.RED, 4, StorageType.NORM, false, 0), new Component(ComponentType.GREEN, 4, StorageType.NORM, false, 0), new Component(ComponentType.BLUE, 4, StorageType.NORM, false, 0), new Component(ComponentType.ALPHA, 4, StorageType.NORM, false, 0)), Collections.singletonList(16), null, false, null));
		INFO.put(3, new VkFormatInfo(3, "VK_FORMAT_B4G4R4A4_UNORM_PACK16", Arrays.asList(new Component(ComponentType.BLUE, 4, StorageType.NORM, false, 0), new Component(ComponentType.GREEN, 4, StorageType.NORM, false, 0), new Component(ComponentType.RED, 4, StorageType.NORM, false, 0), new Component(ComponentType.ALPHA, 4, StorageType.NORM, false, 0)), Collections.singletonList(16), null, false, null));
		INFO.put(51, new VkFormatInfo(51, "VK_FORMAT_A8B8G8R8_UNORM_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 8, StorageType.NORM, false, 0), new Component(ComponentType.BLUE, 8, StorageType.NORM, false, 0), new Component(ComponentType.GREEN, 8, StorageType.NORM, false, 0), new Component(ComponentType.RED, 8, StorageType.NORM, false, 0)), Collections.singletonList(32), null, false, null));
		...
		INFO.put(65, new VkFormatInfo(65, "VK_FORMAT_A2B10G10R10_SNORM_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 2, StorageType.NORM, true, 0), new Component(ComponentType.BLUE, 10, StorageType.NORM, true, 0), new Component(ComponentType.GREEN, 10, StorageType.NORM, true, 0), new Component(ComponentType.RED, 10, StorageType.NORM, true, 0)), Collections.singletonList(32), null, false, null));
		INFO.put(59, new VkFormatInfo(59, "VK_FORMAT_A2R10G10B10_SNORM_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 2, StorageType.NORM, true, 0), new Component(ComponentType.RED, 10, StorageType.NORM, true, 0), new Component(ComponentType.GREEN, 10, StorageType.NORM, true, 0), new Component(ComponentType.BLUE, 10, StorageType.NORM, true, 0)), Collections.singletonList(32), null, false, null));
		...
		INFO.put(64, new VkFormatInfo(64, "VK_FORMAT_A2B10G10R10_UNORM_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 2, StorageType.NORM, false, 0), new Component(ComponentType.BLUE, 10, StorageType.NORM, false, 0), new Component(ComponentType.GREEN, 10, StorageType.NORM, false, 0), new Component(ComponentType.RED, 10, StorageType.NORM, false, 0)), Collections.singletonList(32), null, false, null));
		...
		INFO.put(58, new VkFormatInfo(58, "VK_FORMAT_A2R10G10B10_UNORM_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 2, StorageType.NORM, false, 0), new Component(ComponentType.RED, 10, StorageType.NORM, false, 0), new Component(ComponentType.GREEN, 10, StorageType.NORM, false, 0), new Component(ComponentType.BLUE, 10, StorageType.NORM, false, 0)), Collections.singletonList(32), null, false, null));
		INFO.put(53, new VkFormatInfo(53, "VK_FORMAT_A8B8G8R8_USCALED_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 8, StorageType.SCALED, false, 0), new Component(ComponentType.BLUE, 8, StorageType.SCALED, false, 0), new Component(ComponentType.GREEN, 8, StorageType.SCALED, false, 0), new Component(ComponentType.RED, 8, StorageType.SCALED, false, 0)), Collections.singletonList(32), null, false, null));
		INFO.put(67, new VkFormatInfo(67, "VK_FORMAT_A2B10G10R10_SSCALED_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 2, StorageType.SCALED, true, 0), new Component(ComponentType.BLUE, 10, StorageType.SCALED, true, 0), new Component(ComponentType.GREEN, 10, StorageType.SCALED, true, 0), new Component(ComponentType.RED, 10, StorageType.SCALED, true, 0)), Collections.singletonList(32), null, false, null));
		INFO.put(61, new VkFormatInfo(61, "VK_FORMAT_A2R10G10B10_SSCALED_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 2, StorageType.SCALED, true, 0), new Component(ComponentType.RED, 10, StorageType.SCALED, true, 0), new Component(ComponentType.GREEN, 10, StorageType.SCALED, true, 0), new Component(ComponentType.BLUE, 10, StorageType.SCALED, true, 0)), Collections.singletonList(32), null, false, null));
		INFO.put(66, new VkFormatInfo(66, "VK_FORMAT_A2B10G10R10_USCALED_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 2, StorageType.SCALED, false, 0), new Component(ComponentType.BLUE, 10, StorageType.SCALED, false, 0), new Component(ComponentType.GREEN, 10, StorageType.SCALED, false, 0), new Component(ComponentType.RED, 10, StorageType.SCALED, false, 0)), Collections.singletonList(32), null, false, null));
		INFO.put(60, new VkFormatInfo(60, "VK_FORMAT_A2R10G10B10_USCALED_PACK32", Arrays.asList(new Component(ComponentType.ALPHA, 2, StorageType.SCALED, false, 0), new Component(ComponentType.RED, 10, StorageType.SCALED, false, 0), new Component(ComponentType.GREEN, 10, StorageType.SCALED, false, 0), new Component(ComponentType.BLUE, 10, StorageType.SCALED, false, 0)), Collections.singletonList(32), null, false, null));
		INFO.put(123, new VkFormatInfo(123, "VK_FORMAT_E5B9G9R9_UFLOAT_PACK32", Arrays.asList(new Component(ComponentType.SHARED_EXPONENT, 5, StorageType.FLOAT, false, 0), new Component(ComponentType.BLUE, 9, StorageType.FLOAT, false, 0), new Component(ComponentType.GREEN, 9, StorageType.FLOAT, false, 0), new Component(ComponentType.RED, 9, StorageType.FLOAT, false, 0)), Collections.singletonList(32), null, false, null));
	}
