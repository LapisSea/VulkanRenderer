...
public class VkSwapchain{
	...
	public void create(VkGpu gpu){
		...
		try(MemoryStack stack=stackPush()){
			...
			LogUtil.println(swapchainInfo.sType());
			LogUtil.println(swapchainInfo.pNext());
			LogUtil.println(swapchainInfo.flags());
			LogUtil.println(swapchainInfo.surface());
			LogUtil.println(swapchainInfo.minImageCount());
			LogUtil.println(swapchainInfo.imageFormat());
			LogUtil.println(swapchainInfo.imageColorSpace());
			LogUtil.println(swapchainInfo.imageExtent());
			LogUtil.println(swapchainInfo.imageExtent().width());
			LogUtil.println(swapchainInfo.imageExtent().height());
			LogUtil.println(swapchainInfo.imageArrayLayers());
			LogUtil.println(swapchainInfo.imageUsage());
			LogUtil.println(swapchainInfo.imageSharingMode());
			LogUtil.println(swapchainInfo.queueFamilyIndexCount());
			LogUtil.println(swapchainInfo.pQueueFamilyIndices());
			LogUtil.println(swapchainInfo.preTransform());
			LogUtil.println(swapchainInfo.compositeAlpha());
			LogUtil.println(swapchainInfo.presentMode());
			LogUtil.println(swapchainInfo.clipped());
			LogUtil.println(swapchainInfo.oldSwapchain());
